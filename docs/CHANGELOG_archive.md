# Changelog — Archive (0.7.2 and earlier)

Older entries moved out of the main [CHANGELOG.md](../CHANGELOG.md) to keep
it manageable.  The format matches the main changelog.
