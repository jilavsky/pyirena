...
def _build_report(file_path: str,
                  ...
                  modeling_results: Optional[dict] = None) -> str:
    """
...
class DataSelectorPanel(QWidget):
    ...
    def create_report(self):
        ...
        if not any([show_data, show_fit, show_sizes, show_simple_fits,
                    show_waxs_peakfit, show_modeling]):
            self.status_label.setText(
    ...
    def tabulate_results(self):
        ...
        if not any([show_unified, show_sizes, show_simple_fits,
            ...
            self.status_label.setText(
                ...
                "'WAXS Peaks' or 'Modeling' checkbox"
            )
            return
        ...
        loaded = []   # list of (fname, uf, sz, sf, wp, mod)
        max_levels   = 0
        max_wp_peaks = 0
        max_mod_pops = 0
        ...
        for fp in file_paths:
            ...
            loaded.append((fname, uf, sz, sf, wp, mod))
        ...
        rows = []
        for fname, uf, sz, sf, wp, mod in loaded:
            row = [fname]
